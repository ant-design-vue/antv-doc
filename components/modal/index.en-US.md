...
Additionally, if you need show a simple confirmation dialog, you can use `Vue.$modal.confirm()`,
and so on.
...
|------------|----------------|------------------|--------------|
| value    | Determine whether a modal dialog is visible or not | boolean | no |
| confirmLoading | Determine whether to apply loading visual effect for OK button or not  | boolean    | no           |
| title      | The modal dialog's title          | string\|vnode | no           |
...
| footer     | Footer content, set as `footer={null}` when you don't need default buttons | string\|vnode | OK and cancel button |
...
| Property   | Description    | Type             | Default       |
|------------|----------------|------------------|---------------|
| title      | Title           | string\|vnode | no           |
| content    | Content           | string\|vnode | no          |
| onOk       | Specify a function that will be called when a user clicked OK button. The parameter of this function is a function whose execution should include closing the dialog.    | function         | no           |
| onCancel   | Specify a function that will be called when a user clicked Cancel button. The parameter of this function is a function whose execution should include closing the dialog.       | function         | no           |
